...
export const VOCI_PROGRAMMA = [
  ...
  {
    n: 12,
    // Riformulata il 21/9 (Enrico): il dossier OT23 non esiste ancora; si promette
    // solo ciò che la piattaforma produce — i dati degli interventi erogati.
    nome: 'Dati e documentazione per la domanda OT23',
    cliente: `Dati e documentazione degli interventi erogati, utilizzabili per la domanda OT23 di riduzione del tasso medio INAIL, che l'azienda presenta direttamente o tramite il consulente del lavoro.`,
