...
export const VOCI_PROGRAMMA = [
  ...
  },
  {
    ...
    cliente: `Per chi presenta dolore con impatto funzionale: ciclo di ${PROTOCOLLO.sedute_per_ciclo} sedute con rilevazione del dolore prima e dopo ogni seduta, fino a ${inLettere(PROTOCOLLO.cicli_trattamento_per_anno)} cicli l'anno per persona, con un intervallo minimo tra i cicli.`,
  ...
  },
  {
    ...
    cliente: `Per chi presenta segnali senza impatto funzionale: ${PROTOCOLLO.sessioni_prevenzione_l2} sessioni di prevenzione l'anno per persona, dal primo anno di programma.`,
