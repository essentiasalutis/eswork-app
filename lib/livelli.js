...
export function legendaLivelli(v2Params) {
  ...
  return [
    ...
    },
    {
      ...
      testo: `Chi ha un disturbo in corso che non lo limita ancora, individuato dai dati del check-up. L'osteopata apre il percorso dalla cartella della persona: ${p.prevention_sessions_per_l2} sessioni di prevenzione con l'osteopata, in sede.`,
    },
    {
