...
export function buildQuoteHtml({ client, forchetta, sector_label, v2Doc }) {
  ...
  const v2Section = v2Doc ? `
    ...
    <div class="why">
      ...
      <p>• <strong>Consulenza ergonomico-posturale</strong> sulle postazioni di lavoro${v2Doc.ergonomiaPostazioni > 0 ? ' — <em>la parte relativa alle postazioni di produzione è stimata e verrà confermata con il sopralluogo</em>' : ''}.</p>
    </div>` : '';
...
export function buildPacchettoHtml({ client, pacchetto, naming, sector_label }) {
  ...
  const conPostazioni = !!(p.ergonomia && p.ergonomia.detail && !p.ergonomia.detail.includes(' 0 postazioni'));
...
<div class="page">
  ...
  <div class="body">
    ...
    <div class="why">
      ...
      <p>• <strong>Consulenza ergonomico-posturale</strong> sulle postazioni di lavoro${conPostazioni ? ' — <em>la parte relativa alle postazioni di produzione è stimata e verrà confermata con il sopralluogo</em>' : ''}.</p>
    </div>
