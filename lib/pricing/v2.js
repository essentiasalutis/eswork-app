...
export const DEFAULTS_V2 = {
  ...
  prezzo_assessment_pacchetto: 0,     // ⚠ da definire (parametro admin)
};
...
export function calculatePacchetto({ n, groups, rates, vatExempt, v2Params, ergonomia } = {}) {
  ...
  const assessment = {
    ...
    detail: 'assessment con consensi e flussi clinici identici al programma completo',
    sell: Number(p.prezzo_assessment_pacchetto) || 0,
    cost: 0,
  };
