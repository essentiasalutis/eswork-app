...
// Registro UNICO, istituzionale (13/9): la variante diretta ("Ciao a tutti") è stata
// rimossa — in una micro-impresa il tono formale non stona, il contrario sì.
...
// Registro unico, istituzionale (Enrico, 13/9): vedi la nota in lib/riepilogo.js.
export function testoKitAvvio({ dataAvvio, prenotazione, contatto, firma } = {}) {
...
Sportello in sede. Un osteopata sarà presente in azienda nelle giornate indicate nel calendario allegato, in uno spazio riservato. Le sessioni durano ${PROTOCOLLO.durata_seduta_min} minuti. Per prenotare: ${(prenotazione || '').trim() || '[come prenotare]'}.
...
come concordato, ecco a lei una bozza di testo per annunciare ai dipendenti la partenza del programma: va inoltrata con il calendario delle giornate in allegato, e potete adattarla alle vostre abitudini.
