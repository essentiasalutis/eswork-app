export const CONFIG = {
  ...
  management_services: {
    core: [
      { label: 'Piattaforma digitale ES Work con AI', desc: 'Piattaforma digitale proprietaria con intelligenza artificiale: assessment online, stratificazione automatica, monitoraggio in tempo reale della salute della popolazione, alert quando un dipendente peggiora, e generazione automatica della reportistica con AI.' },
      ...
      { label: 'Coordinamento e regia ES Work', desc: 'Un unico referente che coordina l\'intero programma: gestione degli osteopati, calendario multi-sede, logistica, comunicazione con la direzione e produzione di tutta la reportistica. L\'azienda non deve coordinare nulla.' },
      { label: 'Documentazione OT23 INAIL', desc: 'Documentazione strutturata per la domanda di riduzione del premio assicurativo INAIL (modello OT23), inclusa nel Report Annuale. Può generare un risparmio del 5-28% sul premio.' },
    ],
    plus: [
      ...
      { label: 'Coordinamento e regia dedicato', desc: 'Un unico referente dedicato che coordina osteopati, calendario multi-sede, logistica e reportistica. Include due colloqui semestrali con la direzione e un report esteso con comparazione settoriale.', value: 2500 },
    ...
    enterprise: [
      { label: 'Piattaforma digitale ES Work con AI', desc: 'Piattaforma digitale proprietaria con intelligenza artificiale: assessment online, stratificazione automatica, monitoraggio in tempo reale della salute della popolazione, alert quando un dipendente peggiora, e generazione automatica della reportistica con AI.', value: 1500 },
      { label: '4 Report (Attivazione + 2 Review + Annuale)', desc: 'Report alla direzione in ogni fase: attivazione, due verifiche intermedie a 3 e 6 mesi con KPI clinici aggiornati e raccomandazioni operative, e Report Annuale finale con confronto prima/dopo sui tre KPI di risultato — pronto per il bilancio di sostenibilità.', value: 2000 },
      { label: 'Coordinamento e regia dedicato', desc: 'Account dedicato che coordina l\'intero programma: osteopati, calendario multi-sede, logistica e reportistica. Include due colloqui semestrali con la direzione e un report esteso con comparazione settoriale.', value: 3000 },
      { label: 'Documentazione OT23 INAIL', desc: 'Documentazione strutturata per la domanda di riduzione del premio assicurativo INAIL (modello OT23), inclusa nel Report Annuale. Può generare un risparmio del 5-28% sul premio.', value: 500 },
