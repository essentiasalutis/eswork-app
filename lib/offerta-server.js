...
import { prezzoConTetto, applicaTettoAlCalcolo } from './forbice.mjs';
import { parametriDaStimaCongelata } from './pricing/v2-defaults.mjs';
...
export async function datiOffertaDaCheckup({ assessmentId, n, l1, l2, custom = null } = {}) {
  ...
  const calc = applicaTettoAlCalcolo(calcPieno, tetto, { contractMonths: CONFIG.contract_months || 12 });

  return { client, assessment: { ...assessment, n: responses.length }, nmq, calc, forchetta, responders, l2Mult: l2MultBasis, tetto };
}
