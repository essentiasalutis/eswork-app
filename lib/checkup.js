...
// la firma): così funziona anche quando si firma prima del check-up.
// ─────────────────────────────────────────────────────────────────────────────
...
// limite dei check-up aperti non
...
export function avvisiAvvioCheckup({ client, altriAperti = [], limite = 3 } = {}) {
  ...
  // La Lettera di incarico è uscita dal funnel standard (13/9): non è più un
  // passaggio da fare prima del check-up, quindi qui non si avvisa più di niente.
  // Resta documento opzionale, acceso a mano sulla scheda azienda.
