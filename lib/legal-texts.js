...
export const INFORMATIVA_QUESTIONARIO = {
  ...
  // 2026-09-13.2 — conservazione: cancellazione dei contatti entro 6 mesi se il
  // programma non viene attivato dall'azienda (i contatti si raccolgono anche prima
  // della firma: non esiste un secondo giro per chiederli).
