...
export const CONFIG_V1 = deepFreeze({
  ...
  // Anni di conservazione della documentazione clinica (obbligo normativo).
  // La cancellazione NON è automatica: oltre il termine il sistema SEGNALA i
  // dati nella sezione "Conservazione dati" per la cancellazione validata dal
  // titolare (cancellazione assistita).
  retention_years: 10,
