...
import { conProtocollo, PROTOCOLLO } from '../protocollo.mjs';
export { DEFAULTS_V2 };
...
export function calculatePricing(arg) {
  ...
  return {
    ...
    hours_treated: (p.sessions_per_l1 * p.session_duration_min) / 60 + PROTOCOLLO.formazione_ore_modulo * p.training_modules_y1,
    hours_untreated: PROTOCOLLO.formazione_ore_modulo * p.training_modules_y1,
