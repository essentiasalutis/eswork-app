...
export function leveEconomiche({ dipendenti, premioInail, giorniMalattia, giorniMsk, incidenzaPct = 10, costoGiornata = 160 } = {}) {
  ...
  out.push({
    ...
    nota: 'Forniamo i dati e la documentazione degli interventi erogati, utilizzabili per la domanda; la domanda la presenta l\'azienda (o il consulente del lavoro).',
  });
  out.push({
    titolo: 'Deducibilità',
