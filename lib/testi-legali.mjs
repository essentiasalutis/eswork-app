...
export const DOCUMENTI = {
  ...
  // v66: l'accordo tra Essentia Salutis e il professionista. Il testo arriva
  // dall'avvocato (natura dell'accordo: domanda Q3 nel fascicolo).
  accordo_trattamento_dati: { titolare: 'essentia_salutis', consensi: ['accordo'] },
};
