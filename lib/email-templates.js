...
export function inviteAssessment({ employee_name, company_name, assessment_link }) {
  ...
  return wrapTemplate(`
    ...
    ${infoBox(`⏱️ <strong>Meno di 5 minuti</strong> · 🔒 Riservato · 📱 Puoi farlo da smartphone`)}
    <p style="font-size:14px;color:#475569;line-height:1.6;">
      Le tue risposte sono <strong>riservate</strong>: trattate da Essentia Salutis nel rispetto del segreto professionale. Il tuo datore di lavoro non vedrà mai i tuoi dati individuali; riceve solo risultati in forma aggregata.
    </p>
